...
<div class="container">
    ...
    <div class="card">
        ...
        <div class="card-body">
            @if(Auth::user()->user_role == 99 || Auth::user()->user_role == 1)
                <div class="row">
                    <div class="col-md-6">
                    ...
                    @if (Auth::user()->user_role == 1)
                        <input class="form-check-input" type="radio" name="radio_replacement" id="radio_replacement_no" value="0" checked style="display:none;">
                    @else
                    <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="hidden" name="id" id="id" value="{{ in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->id }}" >
                            <input type="text" placeholder="Firstname" value="{{ in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->fname }}" class="form-control" id="fname" name="fname"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" placeholder="Middlename" value="{{  in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->mname }}" class="form-control" id="mname" name="mname"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" placeholder="Lastname" value="{{  in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->lname }}" class="form-control" id="lname" name="lname"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" placeholder="Address" value="{{  in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->address }}" class="form-control" id="address" name="address"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" placeholder="Contact #" value="{{  in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->contact_num }}" class="form-control" id="contact" name="contact"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" placeholder="Email" value="{{ in_array(auth()->user()->user_role,[99,1]) ? '' : Auth::user()->email }}" class="form-control" id="email" name="email"value="" maxlength="50" disabled="" readonly="" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
