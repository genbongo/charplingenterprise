...
<div class="row">
	<div class="col-sm-12 col-md-6 col-lg-4 bg-light profile-container">
	<!--left col-->
	<div class="card">
		...
		<br>
			...
			@if(Auth::user()->user_role == 1)
				...
				<li class="list-group-item">
					<strong class="text-muted">Assigned Location :</strong>
					<label>&nbsp;{{ $area->area_name }}</label>
				</li>
				<li class="list-group-item">
					<strong class="text-muted">No. assigned Stores :</strong>
					<label>&nbsp;5</label>
				</li>
			@endif

				<li class="list-group-item">
					<strong class="text-muted">Employee ID : </strong>&nbsp;{{ Auth::user()->id }}
				</li>
				<li class="list-group-item">
...
<script type="text/javascript">
		...
		$('#img').on('change',function(ev){
			...
			$('#spn_img_message').html(`
						<p style="color:red">Please select a valid type image. 
							<br/> Only JPG/JPEG/PNG file is allowed!
						</p>`);
